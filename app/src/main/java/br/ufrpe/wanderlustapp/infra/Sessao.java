...
public class Sessao {
    ...
    public void setPlacaVideo(PlacaVideo bar){setValue("sessao.PlacaVideo", bar);}

    public PlacaVideo getPlacaVideo(){return (PlacaVideo) values.get("sessao.PlacaVideo");}
    ...
    public void resetPlaca(){ setPlacaVideo(null);}
