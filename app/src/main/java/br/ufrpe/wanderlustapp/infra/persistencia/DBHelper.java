...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //Tabela Placa
    public static final String TABELA_PLACA = "tb_placa";
    public static final String CAMPO_ID_PLACA = "id";
    public static final String CAMPO_NOME_PLACA = "nome_placa";
    public static final String CAMPO_DESCRICAO_PLACA = "descricao";
    public static final String CAMPO_FK_CIDADE_PLACA= "fk_cidade";
    ...
    private static final String[] TABELAS = {
            TABELA_PESSOA, TABELA_USUARIO, TABELA_PAIS, TABELA_CIDADE, TABELA_PRATO, TABELA_PONTO, TABELA_PLACA, TABELA_PESSOA_PRATO, TABELA_PRATO_IMAGEM, TABELA_PONTO_IMAGEM
    };
    ...
    private void createTablePlaca(SQLiteDatabase db){
        String sqlTbPlaca =
                "CREATE TABLE %1$s ( "  +
                        "  %2$s INTEGER PRIMARY KEY AUTOINCREMENT, " +
                        "  %3$s TEXT NOT NULL, " +
                        ...
                        "  FOREIGN KEY(%6$s) REFERENCES %7$s(%8$s)" +
                        ");";
        sqlTbPlaca = String.format(sqlTbPlaca,
                TABELA_PLACA, CAMPO_ID_PLACA, CAMPO_NOME_PLACA, CAMPO_DESCRICAO_PLACA, CAMPO_FK_CIDADE_PLACA, CAMPO_FK_CIDADE_PLACA, TABELA_CIDADE, CAMPO_ID_CIDADE);
        db.execSQL(sqlTbPlaca);
    }
