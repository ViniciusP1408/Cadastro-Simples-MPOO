...
import br.ufrpe.wanderlustapp.placaVideo.gui.ListaPlacaActivity;
...
public class HomeActivity extends Activity implements
    ...
    private void defineIntent() {
        if(RecyclerViewItemPosition == 0){
            ...
            Intent iniciarGerenciarPlacasdeVideo =
            new Intent(HomeActivity.this, ListaPlacaActivity.class);
            startActivity(iniciarGerenciarPlacasdeVideo);
        }
    ...
    public void AddItemsToRecyclerViewArrayList(){
        ...
        Tela.add("Gerenciar placas de Video");
